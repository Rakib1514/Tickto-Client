...
//     <div
//       ref={carouselRef}
//       className="carousel bg-black relative overflow-hidden w-screen h-fit md:min-h-screen"
//     >
...
//               <div className="author font-bold tracking-[10px] text-xl">
//                 <span className="text-[#317371]">TICK</span>TO
//               </div>
//               <div className="title text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mt-3 my-3 text-yellow-600">
//                 {slide.title}
//               </div>
//               <div className="des md:text-lg leading-tight mb-8">
//                 {slide.description}
//               </div>

//               <div className="buttons flex gap-2 mt-5">
//                 <button className="btn shadow-none px-6 bg-[#317371] text-white border-none tracking-wider">
//                   SEE MORE
//                 </button>
//                 <button className="btn shadow-none px-6 border border-[#317371] text-[#317371] bg-transparent tracking-wider">
//                   SUBSCRIBE
//                 </button>
//               </div>
//             </div>
...
//       <div
//         ref={thumbRef}
//         className="thumbnail absolute bottom-[50px] left-1/2 -translate-x-1/2 flex gap-5 z-[100]"
//       >
//         {slides.map((slide, index) => (
...
//       <div
//         ref={timeRef}
//         className="time absolute top-0 left-0 h-[3px] bg-gray-600 z-[1000] running"
//       ></div>
//     </div>
//   );
// }
