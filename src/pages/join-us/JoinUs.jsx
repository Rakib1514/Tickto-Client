    ...
    <div className="min-h-screen ">
        ...
        <div className="h-[480px] w-full bg-black/45 flex items-center justify-center">
          <div className="text-center text-white space-y-3 md:w-1/2 mx-auto">
            ...
            <p className="w-[96%] mx-auto">
              ...
              designer, marketer, or customer support superstar, there's a place
              for you here. Come be a part of something meaningful and help us
      ...
      <div className="mx-auto mt-24 w-[94%] max-w-screen-xl pb-28">
        ...
        <p className="py-4 pb-6 text-lg md:w-[80%]">
          Behind every great experience is a team of passionate individuals
          dedicated to making your life easy. At Tickto, our experts in
          technology, customer support, and event management work together to
          deliver a seamless platform for you. We believe in innovation,
          collaboration, and creating unforgettable experiences—one ticket at a
          time!
        </p>
