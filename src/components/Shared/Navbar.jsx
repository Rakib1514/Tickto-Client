                ...
                <div className="hidden sm:space-x-4 lg:ml-8 lg:flex mx-4">
                  {navLinks.map(({ path, label, icon: Icon }, index) => (
                    <NavLink
                      key={index}
                      to={path}
                      className={`inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors duration-150 ${isActivePath(path)
                ...
                <div className="space-y-1 pt-2 pb-3">
                  {navLinks.map(({ path, label, icon: Icon }, index) => (
                    <NavLink
                      key={index}
                      to={path}
                      className={`flex items-center rounded-md px-3 py-2 font-medium transition-colors duration-150 ${isActivePath(path)
